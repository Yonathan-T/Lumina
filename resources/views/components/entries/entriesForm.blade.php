    ...
    <form method="POST" action="/entries">
      ...
      <div class="flex flex-col gap-6">
        ...
        <x-form-wrapper>
          ...
          <textarea id="content" name="content" type="text" placeholder="What’s one thing you’re grateful for today?"
            class="w-full px-4 py-2 rounded-md focus:ring-[#c2b68e] bg-white/5 focus:border-[#c2b68e]">
