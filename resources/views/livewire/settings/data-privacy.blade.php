<div class="space-y-6">
    <!-- Flash Messages -->
    @if (session('success'))
        <div id="success-message" class="bg-gradient-dark card-highlight border border-white/10 Rounded-lg px-6 py-4 shadow-lg backdrop-blur-sm border border-green-500/20">
            <div class="flex items-center justify-between">
                ...
                <button onclick="dismissMessage('success-message')" class="text-gray-400 hover:text-white transition-colors">
    ...
    @if (session('error'))
        <div id="error-message" class="bg-gradient-dark card-highlight rounded-lg px-6 py-4 shadow-lg backdrop-blur-sm border border-red-500/20">
            <div class="flex items-center justify-between">
                <div class="flex items-center gap-3">
    ...
    <div class="bg-gradient-dark card-highlight rounded-lg overflow-hidden">
        <div class="p-6 border-b border-white/10">
            ...
            <p class="text-sm text-gray-400 mt-1">Download your journal entries and data</p>
        </div>
        ...
        <div class="p-6">
            <button type="button" wire:click="exportData" wire:loading.attr="disabled" wire:target="exportData"
                ...
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        <p class="font-semibold text-white">Export All Entries</p>
